...
public class NurseWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : nurseOrganization.getWorkQueue().getWorkRequestList()){
            ...
            row[4] = ((LabTestWorkRequest)request).getRequestDate() == null ? null : ((LabTestWorkRequest)request).getRequestDate();
            row[5] = ((LabTestWorkRequest)request).getDonor() == null ? null : ((LabTestWorkRequest)request).getDonor();
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Message", "Sender", "Receiver", "Status", "Requested  Date", "Donor"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 530, 96));
